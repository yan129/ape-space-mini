<template>
	<view class="content-top">
		<swiper @change="swiperChange" :style="{height:height+'rpx'}" circular="true" autoplay="true" interval="5000" :previous-margin="previousMargin" :next-margin="nextMargin">
...
<script>
	export default {
		props: {
			...
			// 在style中设置，animation="swiperConfig.animation"调整动画时间，interval在代码标签中设置
...
<style>
	...
	.Select1 {
		...
		border-radius: 10rpx;
		margin-left: 10rpx;
		animation: Select1 4s 0s 1 forwards;
