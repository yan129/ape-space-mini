<template>
	<view class="uni-easyinput" :class="{'uni-easyinput-error':msg}" :style="{color:inputBorder && msg?'#dd524d':styles.color, borderBottom: inputFlag ? '1px solid #595a78' : '1px solid #eee'}">
