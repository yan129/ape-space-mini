  ...
  <view class="mine-container page">
    <view class="mine-top" :style="{ background: (backImg != '' ? `url(${backImg})` : 'linear-gradient(-225deg, #473B7B 0%, #3584A7 51%, #30D2BE 100%)') }">
      ...
      <view class="avatar-box">
        <image class="avatar" @click="previewImg(userInfo)" :src="userInfo.avatar != null ? userInfo.avatar : 'https://ape-space.oss-cn-shenzhen.aliyuncs.com/avatar/avatar.jpg'"></image>
      </view>
